...
# “+”图标
add_high_school_icon = By.XPATH, '//*[@resource-id="app"]//android.view.View[10]/android.widget.Image[1]'
...
# 校园搜索框输入清华
add_high_school_search = By.XPATH, '/hierarchy//android.view.View[13]//android.widget.EditText'

# 搜索清华
add_high_school_search_qh = By.XPATH, '/hierarchy//android.view.View[13]/android.view.View[2]/android.view.View[1]'
